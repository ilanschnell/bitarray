...
NEW_IN = {
    ...
    'bitarray.fill':         '3.12: add optional alignment argument',
    'bitarray.find':         ['2.1',
...
DOCS = {
    ...
    'codecs': ('Comparison of bitarray codecs', 'codecs.rst'),
...
DOC_LINKS = {
    ...
    'util.random_p':          'random',
    'util.serialize':         'repr',
    'util.sc_decode':         'sc codecs',
    'util.sc_encode':         'sc codecs',
    'util.sc_stat':           'sc',
    'util.rl_decode':         'codecs',
    'util.rl_encode':         'codecs',
    'util.vl_decode':         'vl codecs',
    'util.vl_encode':         'vl codecs',
}
