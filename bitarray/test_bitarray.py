...
class Util:
    ...
    def assertRaisesMessage(self, excClass, msg, callable, *args, **kwargs):
        try:
            ...
            if msg != str(e):
                raise AssertionError(f"message: {msg}\n got: {e}")
...
class TestsModuleFunctions(unittest.TestCase, Util):
    ...
    def test_set_default_endian(self):
        ...
        for default_endian in 'big', 'little', 'big', 'little':
...
class CreateObjectTests(unittest.TestCase, Util):
    ...
    def test_string01(self):
        for s in ('0010111', '0010111', '0010 111', '0010 111',
                  '0010_111', '0010_111'):
            a = bitarray(s)
    ...
    def test_bitarray_endian(self):
        ...
        # existing bitarray.
        for endian in 'little', 'big', 'little', 'big':
            a = bitarray(endian=endian)
            b = bitarray(a)
            self.assertFalse(a is b)
            self.assertEQUAL(a, b)
...
class ExtendTests(unittest.TestCase, Util):
    ...
    def test_unicode(self):
        ...
        self.assertRaises(UnicodeEncodeError, a.extend, '1\u2605 0')
        self.assertEqual(a, bitarray('001011'))
        self.check_obj(a)
...
class CountTests(unittest.TestCase, Util):
    ...
    def test_sparse(self):
        N = 65536
        a = zeros(N)
        indices = {randrange(N) for _ in range(256)}
        a[list(indices)] = 1
