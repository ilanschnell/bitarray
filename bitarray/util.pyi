...
def sc_stat(stream: Iterable[int]) -> dict: ...
def rl_encode(a: bitarray) -> bytes: ...
def rl_decode(stream: Iterable[int],
              endian: Optional[str] = ...) -> bitarray: ...
def vl_encode(a: bitarray) -> bytes: ...
def vl_decode(stream: Iterable[int],
              endian: Optional[str] = ...) -> bitarray: ...

def _huffman_tree(f: FreqMap) -> Any: ...
def huffman_code(f: FreqMap, endian: Optional[str] = ...) -> CodeDict: ...
def canonical_huffman(f: FreqMap) -> tuple[CodeDict, list, list]: ...
