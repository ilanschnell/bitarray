...
(i) `int` to create bitarray (initialized to zeros) of given length\n\
(ii) `str` to Unicode string of 0s and 1s\n\
(iii) `bytes` or `bytearray` to initialize buffer directly\n\
(iv) iterable of integers 0 or 1.\n\
\n\
